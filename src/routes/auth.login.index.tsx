...
import LoginPageDev from '@/components/dev/login-page';
...
function RouteComponent() {
	...
	useEffect(() => {
		if(!error) return;
		toast.error("An error occured!", {description: error || "Please try again later."});
		setIsLoading(false);
	}, [error])
	...
	return (
		<div className='min-h-screen w-full flex flex-col items-center justify-center gap-6'>
			...
			<LoginPageDev onSelect={(email, password) => {
